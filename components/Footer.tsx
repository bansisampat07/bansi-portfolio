    ...
    <footer id="contact" className="py-20 px-6 border-t border-white/5 bg-slate-950">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-10">
        ...
        <div className="flex flex-col space-y-4 items-center md:items-start">
          <a href="mailto:sampat.bansi@gmail.com" className="flex items-center space-x-3 text-lg hover:text-sky-400 transition-colors">
            <span className="p-2 bg-slate-800 rounded-lg">📧</span>
            <span>sampat.bansi@gmail.com</span>
          </a>
          <div className="flex items-center space-x-3 text-lg">
            <span className="p-2 bg-slate-800 rounded-lg">📞</span>
            <span>+91 7021523375</span>
          </div>
          <div className="flex space-x-4 pt-4">
             <a href="https://github.com/bansisampat07" target="_blank" className="p-3 bg-slate-800 hover:bg-slate-700 rounded-full transition-colors">
             ...
             <a href="https://linkedin.com/in/bansi-sampat" target="_blank" className="p-3 bg-slate-800 hover:bg-slate-700 rounded-full transition-colors">
